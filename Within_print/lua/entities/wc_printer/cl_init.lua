...
function ENT:Initialize()
	...
	self.batterybar = hg_printer.battery
	self.timebar = 0
	self.smoothtime = 0
end
...
function ENT:Draw()
	...
	cam.Start3D2D(Pos + Ang:Up() * 8, Ang, 0.05)
		...
		draw.SimpleTextOutlined(hg_printer.name, "r96", x + 220, y + 100, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM, 1, Color(0, 0, 0, 255))
		...
		surface.DrawRect(x + 10, y + 170, self.timebar * (420 / (hg_printer.printtime - 1)), 40)
		draw.SimpleTextOutlined("Next Print: "..math.Round(((self.smoothtime / hg_printer.printtime)*100)+14).."%", "r32", x + 15, y + 185, Color(255, 255, 255, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0, 255))
		...
		draw.SimpleTextOutlined("Battery ( $"..hg_printer.newbattery.." )", "r32", x + 330, y + 305, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0, 255))
	cam.End3D2D()
end 
